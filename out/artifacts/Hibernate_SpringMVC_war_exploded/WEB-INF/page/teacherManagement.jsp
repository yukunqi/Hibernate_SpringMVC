                   ...
                   <div class="row">
                     <div class="col-sm-6">
                       <div id="example1_length" class="dataTable_length">
                         <label>
                           老师类型：<select id="user_type" class="form-control input-sm" name="example1_length" aria-controls="example1"></select>
                         </label>
                       </div>
                     </div>
                     <div class="col-sm-6">
...
<%--  <script src="static/dist/js/pages/dashboard2.js"></script>--%>
  ...
  <script id="tp1" type="text/template">
    <table class="table table-bordered table-striped" role="grid" aria-describedby="example1_info">
      ...
      <tr role="row">
        ...
        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="teacher number">教师学号</th>
        ...
        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="teacher phone_number">老师类型</th>
  ...
  <script type="text/javascript">
    ...
    $.ajax({
      url:"${pageContext.request.contextPath}/upload/GET/ExpertList/2/"+page_num,
      type:"GET",
      dataType:"json",
    ...
    function load_page_button_1(current_page,first_page,final_page) {
        ...
        if (current_page-first_page<=3&&final_page-current_page>=4){
            ...
            for(i=1;i<=(current_page-'0')+2;i++){
                ...
                a.setAttribute('href','${pageContext.request.contextPath}/index/teacherManagement?page='+i);
    ...
    function create_previous_button(current_page,first_page,pre_page) {
        ...
        if(current_page==first_page){
            ...
            a.setAttribute('href','${pageContext.request.contextPath}/index/teacherManagement?page='+pre_page);
        }
        a.setAttribute('aria-controls','example1');
        a.setAttribute('data-dt-idx','0');
        a.setAttribute('tabindex','0');
    ...
    function create_next_button(current_page,final_page,next_page) {
        ...
        if (current_page==final_page){
            ...
            a.setAttribute('href','${pageContext.request.contextPath}/index/teacherManagement?page='+next_page);
        }
        a.setAttribute('aria-controls','example1');
        a.setAttribute('data-dt-idx','0');
        a.setAttribute('tabindex','0');
    ...
    function create_first_button(first_page) {
        ...
        li.setAttribute('class','paginate_button');
        a=document.createElement('a');
        a.setAttribute('href','${pageContext.request.contextPath}/index/teacherManagement?page='+first_page);
        a.setAttribute('aria-controls','example1');
        a.setAttribute('data-dt-idx','0');
        a.setAttribute('tabindex','0');
    ...
    function create_final_button(final_page) {
        ...
        li.setAttribute('class','paginate_button');
        a=document.createElement('a');
        a.setAttribute('href','${pageContext.request.contextPath}/index/teacherManagement?page='+final_page);
        a.setAttribute('aria-controls','example1');
        a.setAttribute('data-dt-idx','0');
        a.setAttribute('tabindex','0');
