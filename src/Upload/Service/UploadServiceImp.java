...
public class UploadServiceImp implements UploadService {
    ...
    private Logger logger=Logger.getLogger(UploadServiceImp.class.getName());
                ...
                if (file!=null){
                   String fileName=file.getOriginalFilename();
                    ...
                    if (fileName.trim()!=""){
                        ...
                        //指定文件的存放路径
                        String dirpath=makePath(NewfileName,request.getServletContext().getRealPath("/fileupload"));
                        //生成文件，路径是存放路径+文件名
    ...
    private String CreateRelativePath(String absoultePath){
            return absoultePath.substring(absoultePath.indexOf("fileupload"));
    }
}
